...
void EnOceanActuatorModel::Run()
{
	...
	while(true)
	{
		...
		if (sPhysicalId != "")
		{
			...
			SystemLog::AddLog(SystemLog::SUCCESS, "ActuatorModel : Transmission de l'ordre de pilotage � l'actionneur");
		}
		else
		{
			SystemLog::AddLog(SystemLog::ERROR, "Transmission de l'ordre de pilotage � l'actionneur");
		}
