...
create table sensors_values (id int(11) not null auto_increment, time datetime not null, room int(11) not null, metric int(11) not null,  value int(11) not null, primary key id (id));
